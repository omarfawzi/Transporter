...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-154173e2", module.exports)
  } else {
    hotAPI.update("_v-154173e2", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"vue":8,"vue-hot-reload-api":3}],10:[function(require,module,exports){
"use strict";
...
var _deliveryMen = require("../js/deliveryMen.js");

var _deliveryMen2 = _interopRequireDefault(_deliveryMen);
...
exports.default = {
    ...
    mounted: function mounted() {
        _deliveryMen2.default.getDeliveryMen(this);
    },
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-08b1b2fc", module.exports)
  } else {
    hotAPI.update("_v-08b1b2fc", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"../js/deliveryMen.js":21,"vue":8,"vue-hot-reload-api":3}],11:[function(require,module,exports){
'use strict';
...
exports.default = {
    ...
    methods: {
        resetPassword: function resetPassword() {
            _auth2.default.resetPassword(this);
        }
    },
    mounted: function mounted() {
        _auth2.default.check(true, 'forgetPassword');
    }
};
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<div class=\"wrapper\">\n\n    <nav class=\"navbar navbar-default\">\n\n        <div class=\"container-fluid\">\n\n            <div class=\"navbar-header\">\n                <router-link :to=\"{ name: 'login'}\" class=\"navbar-brand\">Transporter</router-link>\n            </div>\n\n        </div>\n    </nav>\n<div class=\"container\">\n    <div class=\"row\">\n        <div class=\"col-md-8 col-md-offset-2\">\n            <div class=\"panel panel-default\">\n                <div class=\"panel-heading\">Reset Password</div>\n\n                <div class=\"panel-body\">\n                    <div class=\"alert alert-danger\" v-if=\"error\">\n                        <p>Email don't exists</p>\n                    </div>\n                    <div class=\"alert alert-danger\" v-if=\"networkError\">\n                        <p>Check Internet Connection</p>\n                    </div>\n                    <form class=\"form-horizontal\" v-on:submit=\"resetPassword\">\n\n                        <div class=\"form-group\">\n                            <label for=\"email\" class=\"col-md-4 control-label\">E-Mail Address</label>\n\n                            <div class=\"col-md-6\">\n                                <input id=\"email\" type=\"email\" class=\"form-control border-input\" v-model=\"email\" required=\"\">\n                            </div>\n                        </div>\n\n                        <div class=\"form-group\">\n                            <div class=\"col-md-6 col-md-offset-4\">\n                                <button type=\"submit\" class=\"btn btn-primary\">\n                                    Send Password Reset Link\n                                </button>\n                            </div>\n                        </div>\n                    </form>\n                </div>\n            </div>\n        </div>\n    </div>\n</div>\n    <footer class=\"footer navbar-default\" style=\"bottom: 0;width:100%;position: absolute;\">\n\n        <div class=\"container-fluid\">\n\n            <div class=\"copyright pull-right\">\n                © 2017 Transporter. All Rights Reserved\n            </div>\n\n        </div>\n\n    </footer>\n</div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-5decccd0", module.exports)
  } else {
    hotAPI.update("_v-5decccd0", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"../js/auth.js":20,"vue":8,"vue-hot-reload-api":3}],12:[function(require,module,exports){
'use strict';
...
exports.default = {
    data: function data() {
        return {
            sidebar: [{ route: 'orders', label: 'Orders', icon: 'fa fa-truck', active: 'active' }, { route: 'placeOrder', label: 'Place Order', icon: 'fa fa-cog', active: '' }, { route: 'deliveryMen', label: 'Delivery Men', icon: 'fa fa-male', active: '' }, { route: 'money', label: 'Money', icon: 'fa fa-money', active: '' }],
            auth: _auth2.default
        };
    },
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-2178254f", module.exports)
  } else {
    hotAPI.update("_v-2178254f", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"../js/auth.js":20,"vue":8,"vue-hot-reload-api":3}],13:[function(require,module,exports){
'use strict';
...
var _orders = require('../js/orders.js');
...
exports.default = {
    ...
    methods: {
        updateOrder: function updateOrder() {
            ...
            _orders2.default.updateOrder(this);
        },
        cancelOrder: function cancelOrder() {
            _orders2.default.cancelOrder(this);
        }
    },
    mounted: function mounted() {
        _orders2.default.getSpecificOrder(this);
    }
};
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<div class=\"content\">\n\n    <div class=\"container-fluid\">\n\n        <div class=\"row\">\n\n            <div class=\"col-md-12\">\n\n                <div class=\"card\">\n\n                    <div class=\"header\">\n\n                        <h4 class=\"title\">Manage Order</h4>\n\n                    </div>\n\n                    <div class=\"content\">\n\n                        <div class=\"alert alert-danger\" v-if=\"error &amp;&amp; !success\">\n                            <p>Check Internet Connection</p>\n                        </div>\n\n                        <div class=\"alert alert-success\" v-if=\"success\">\n                            <p>Order updated successfully</p>\n                        </div>\n\n                        <form role=\"form\" v-on:submit=\"updateOrder\">\n\n\n                            <div class=\"row\">\n\n                                <div class=\"col-md-4\">\n\n                                    <div class=\"form-group\">\n\n                                        <label>Customer Name</label>\n\n                                        <input type=\"text\" v-model=\"customerName\" class=\"form-control border-input\" placeholder=\"Customer Name\" required=\"\">\n\n                                    </div>\n\n                                </div>\n\n                                <div class=\"col-md-4\">\n\n                                    <div class=\"form-group\">\n\n                                        <label>Mobile Number</label>\n\n                                        <input type=\"number\" v-model=\"mobileNumber\" class=\"form-control border-input\" placeholder=\"Mobile Number\" required=\"\">\n\n                                    </div>\n\n                                </div>\n\n                                <div class=\"col-md-4\">\n\n                                    <div class=\"form-group\">\n\n                                        <label>Customer Mobile Number</label>\n\n                                        <input type=\"number\" v-model=\"customerMobileNumber\" class=\"form-control border-input\" placeholder=\"Customer Mobile Number\" required=\"\">\n\n                                    </div>\n\n                                </div>\n\n                            </div>\n\n                            <div class=\"row\">\n\n                                <div class=\"col-md-4\">\n\n                                    <div class=\"form-group\">\n\n                                        <label>Source Region</label>\n\n                                        <input type=\"text\" v-model=\"sourceRegion\" class=\"form-control border-input\" placeholder=\"Source Region\" required=\"\">\n\n                                    </div>\n\n                                </div>\n\n                                <div class=\"col-md-4\">\n\n                                    <div class=\"form-group\">\n\n                                        <label>Source Address</label>\n\n                                        <input type=\"text\" v-model=\"sourceAddress\" class=\"form-control border-input\" placeholder=\"Source Address\" required=\"\">\n\n                                    </div>\n\n                                </div>\n\n                            </div>\n\n                            <div class=\"row\">\n\n                                <div class=\"col-md-4\">\n\n                                    <div class=\"form-group\">\n\n                                        <label>Destination Region</label>\n\n                                        <input type=\"text\" v-model=\"destinationRegion\" class=\"form-control border-input\" placeholder=\"Destination Region\" required=\"\">\n\n                                    </div>\n\n                                </div>\n\n                                <div class=\"col-md-4\">\n\n                                    <div class=\"form-group\">\n\n                                        <label>Destination Address</label>\n\n                                        <input type=\"text\" v-model=\"destinationAddress\" class=\"form-control border-input\" placeholder=\"Destination Address\" required=\"\">\n\n                                    </div>\n\n                                </div>\n\n                            </div>\n\n                            <div class=\"row\">\n\n                                <div class=\"col-md-4\">\n\n                                    <div class=\"form-group\">\n\n                                        <label>Size (in kg)</label>\n\n                                        <input type=\"number\" v-model=\"size\" class=\"form-control border-input\" placeholder=\"Size\" required=\"\">\n\n                                    </div>\n\n                                </div>\n\n                                <div class=\"col-md-4\">\n\n                                    <div class=\"form-group\">\n\n                                        <label>Order Cost</label>\n\n                                        <input type=\"text\" v-model=\"orderCost\" class=\"form-control border-input\" placeholder=\"Order Cost\" required=\"\">\n\n                                    </div>\n\n                                </div>\n                                <div class=\"col-md-4\">\n\n                                    <div class=\"form-group\">\n\n                                        <label>Delivery Cost</label>\n\n                                        <input type=\"text\" v-model=\"deliveryCost\" class=\"form-control border-input\" placeholder=\"Delivery Cost\" required=\"\">\n                                    </div>\n\n                                </div>\n                            </div>\n\n                            <div class=\"row\">\n                                <div class=\"col-md-4\">\n\n                                    <div class=\"form-group\">\n\n                                        <label>Delivery Man</label>\n\n                                        <select class=\"form-control border-input\" v-model=\"deliveryMan\">\n                                            <option class=\"form-control\" v-for=\"item in deliveryMen\" v-bind:value=\"item.deliveryManID\">{{item.fName + ' ' + item.lName}}</option>\n                                        </select>\n\n                                    </div>\n                                </div>\n                                <div class=\"col-md-8\">\n                                    <div class=\"form-group\">\n\n                                        <label>Description</label>\n                                        <textarea class=\"form-control border-input\" v-model=\"description\">\n\n                                        </textarea>\n                                    </div>\n                                </div>\n                            </div>\n\n                            <div class=\"clearfix\"></div>\n\n                            <div class=\"text-center form-group\">\n\n                                <button type=\"submit\" class=\"btn btn-info btn-fill btn-wd\">\n                                    <i class=\"fa fa-edit\"></i>\n                                    Update\n                                </button>\n\n                                <a v-on:click=\"cancelOrder\" class=\"btn btn-danger btn-fill\">\n                                    <i class=\"fa fa-trash\"></i>\n                                    Cancel Order\n                                </a>\n\n                            </div>\n\n                            <div class=\"clearfix\"></div>\n\n                        </form>\n\n                    </div>\n\n                </div>\n\n            </div>\n\n        </div>\n\n    </div>\n\n</div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-275d6ea9", module.exports)
  } else {
    hotAPI.update("_v-275d6ea9", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"../js/orders.js":23,"vue":8,"vue-hot-reload-api":3}],14:[function(require,module,exports){
'use strict';
...
var _money = require('../js/money.js');
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-2bc91900", module.exports)
  } else {
    hotAPI.update("_v-2bc91900", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"../js/money.js":22,"vue":8,"vue-hot-reload-api":3}],15:[function(require,module,exports){
'use strict';
...
exports.default = {
    ...
    mounted: function mounted() {
        _orders2.default.getOrders(this);
    },

    methods: {
        exportOrders: function exportOrders() {
            var currentUrl = 'http://' + location.hostname + ':' + location.port + '/api/exportOrders';
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-48afab56", module.exports)
  } else {
    hotAPI.update("_v-48afab56", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"../js/orders.js":23,"vue":8,"vue-hot-reload-api":3}],16:[function(require,module,exports){
'use strict';
...
exports.default = {
    ...
    methods: {
        placeOrder: function placeOrder() {
            _orders2.default.placeOrder(this);
        }
    }
};
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<div class=\"content\">\n\n    <div class=\"container-fluid\">\n\n        <div class=\"row\">\n\n            <div class=\"col-md-12\">\n\n                <div class=\"card\">\n\n                    <div class=\"header\">\n\n                        <h4 class=\"title\">Place Order</h4>\n\n                    </div>\n\n                    <div class=\"content\">\n\n                        <div class=\"alert alert-danger\" v-if=\"error &amp;&amp; !success\">\n                            <p>There was an error, unable to complete order.</p>\n                        </div>\n\n                        <div class=\"alert alert-success\" v-if=\"success\">\n                            <p>Order placed successfully</p>\n                        </div>\n\n                        <form role=\"form\" v-on:submit=\"placeOrder\">\n\n\n                            <div class=\"row\">\n\n                                <div class=\"col-md-4\">\n\n                                    <div class=\"form-group\">\n\n                                        <label>Customer Name</label>\n\n                                        <input type=\"text\" v-model=\"customerName\" class=\"form-control border-input\" placeholder=\"Customer Name\" required=\"\">\n\n                                    </div>\n\n                                </div>\n\n                                <div class=\"col-md-4\">\n\n                                    <div class=\"form-group\">\n\n                                        <label>Mobile Number</label>\n\n                                        <input type=\"number\" v-model=\"mobileNumber\" class=\"form-control border-input\" placeholder=\"Mobile Number\" required=\"\">\n\n                                    </div>\n\n                                </div>\n\n                                <div class=\"col-md-4\">\n\n                                    <div class=\"form-group\">\n\n                                        <label>Mobile Number</label>\n\n                                        <input type=\"number\" v-model=\"customerMobileNumber\" class=\"form-control border-input\" placeholder=\"Customer Mobile Number\" required=\"\">\n\n                                    </div>\n\n                                </div>\n\n                            </div>\n\n                            <div class=\"row\">\n\n                                <div class=\"col-md-4\">\n\n                                    <div class=\"form-group\">\n\n                                        <label>Source Region</label>\n\n                                        <input type=\"text\" v-model=\"sourceRegion\" class=\"form-control border-input\" placeholder=\"Source Region\" required=\"\">\n\n                                    </div>\n\n                                </div>\n\n                                <div class=\"col-md-4\">\n\n                                    <div class=\"form-group\">\n\n                                        <label>Source Address</label>\n\n                                        <input type=\"text\" v-model=\"sourceAddress\" class=\"form-control border-input\" placeholder=\"Source Address\" required=\"\">\n\n                                    </div>\n\n                                </div>\n\n                            </div>\n\n                            <div class=\"row\">\n\n                                <div class=\"col-md-4\">\n\n                                    <div class=\"form-group\">\n\n                                        <label>Destination Region</label>\n\n                                        <input type=\"text\" v-model=\"destinationRegion\" class=\"form-control border-input\" placeholder=\"Destination Region\" required=\"\">\n\n                                    </div>\n\n                                </div>\n\n                                <div class=\"col-md-4\">\n\n                                    <div class=\"form-group\">\n\n                                        <label>Destination Address</label>\n\n                                        <input type=\"text\" v-model=\"destinationAddress\" class=\"form-control border-input\" placeholder=\"Destination Address\" required=\"\">\n\n                                    </div>\n\n                                </div>\n\n                            </div>\n\n                            <div class=\"row\">\n\n                                <div class=\"col-md-4\">\n\n                                    <div class=\"form-group\">\n\n                                        <label>Size (in kg)</label>\n\n                                        <input type=\"number\" v-model=\"size\" class=\"form-control border-input\" placeholder=\"Size\" required=\"\">\n\n                                    </div>\n\n                                </div>\n\n                                <div class=\"col-md-4\">\n\n                                    <div class=\"form-group\">\n\n                                        <label>Order Cost</label>\n\n                                        <input type=\"text\" v-model=\"orderCost\" class=\"form-control border-input\" placeholder=\"Order Cost\" required=\"\">\n\n                                    </div>\n\n                                </div>\n                                <div class=\"col-md-4\">\n\n                                    <div class=\"form-group\">\n\n                                        <label>Delivery Cost</label>\n\n                                        <input type=\"text\" v-model=\"deliveryCost\" class=\"form-control border-input\" placeholder=\"Delivery Cost\" required=\"\">\n                                    </div>\n\n                                </div>\n                            </div>\n\n                            <div class=\"row\">\n                                <div class=\"col-md-4\">\n\n                                    <div class=\"form-group\">\n\n                                        <label>Delivery Man</label>\n\n                                        <select class=\"form-control border-input\" v-model=\"deliveryMan\">\n                                            <option class=\"form-control\">ay 7ad</option>\n                                        </select>\n\n                                    </div>\n                                </div>\n\n                                <div class=\"col-md-8\">\n                                    <div class=\"form-group\">\n\n                                        <label>Description</label>\n                                        <textarea class=\"form-control border-input\" v-model=\"description\">\n\n                                        </textarea>\n                                    </div>\n                                </div>\n                            </div>\n\n                            <div class=\"clearfix\"></div>\n\n                            <div class=\"text-center form-group\">\n\n                                <button type=\"submit\" class=\"btn btn-info btn-fill btn-wd\">Place Order</button>\n\n                            </div>\n\n                            <div class=\"clearfix\"></div>\n\n                        </form>\n\n                    </div>\n\n                </div>\n\n            </div>\n\n        </div>\n\n    </div>\n\n</div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-ac37f612", module.exports)
  } else {
    hotAPI.update("_v-ac37f612", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"../js/orders.js":23,"vue":8,"vue-hot-reload-api":3}],17:[function(require,module,exports){
'use strict';
...
exports.default = {
    ...
    methods: {
        ...
        register: function register(event) {
            ...
            _auth2.default.register(this, this.email, this.password, this.password_confirmation, this.name);
        }
    },
    mounted: function mounted() {
        _auth2.default.check(false);
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<div class=\"wrapper\">\n\n    <nav class=\"navbar navbar-default\">\n\n        <div class=\"container-fluid\">\n\n            <div class=\"navbar-header\">\n                <router-link :to=\"{ name: 'orders'}\" class=\"navbar-brand\">Transporter</router-link>\n            </div>\n            <div class=\"collapse navbar-collapse\">\n\n                <ul class=\"nav navbar-nav navbar-right\">\n\n                    <li class=\"dropdown\">\n\n                        <a href=\"#\" class=\"dropdown-toggle\" data-toggle=\"dropdown\">\n\n                            <i class=\"ti-user\"></i>\n\n                            <p v-if=\"auth.user.authenticated\">{{ auth.user.profile.name }}</p>\n\n                            <span style=\"font-size:0.6em\">admin</span>\n\n                            <b class=\"caret\"></b>\n\n                        </a>\n\n                        <ul class=\"dropdown-menu\">\n                            <router-link :to=\"{name:'register'}\" tag=\"li\">\n                                <a>\n                                    <i class=\"fa fa-users\"></i>\n                                    Add Admin\n                                </a>\n                            </router-link>\n                            <li>\n                                <a href=\"javascript:;\" v-on:click=\"signout\">\n                                    <i class=\"fa fa-sign-out\"></i>\n                                    Sign Out\n                                </a>\n                            </li>\n\n                        </ul>\n\n                    </li>\n\n                </ul>\n\n            </div>\n        </div>\n    </nav>\n    <div class=\"container\">\n        <div class=\"row\">\n            <div class=\"col-md-8 col-md-offset-2\">\n                <div class=\"panel panel-default\">\n                    <div class=\"panel-heading\">Register</div>\n                    <div class=\"panel-body\">\n                        <div class=\"alert alert-danger\" v-if=\"error &amp;&amp; !success\">\n                            <p>There was an error, unable to complete registration.</p>\n                        </div>\n                        <div class=\"alert alert-success\" v-if=\"success\">\n                            <p>Registration completed. You can now sign in.</p>\n                        </div>\n                        <form class=\"form-horizontal\" role=\"form\" v-on:submit=\"register\" v-if=\"!success\">\n                            <div class=\"form-group\">\n                                <label for=\"name\" class=\"col-md-3 control-label\">Name</label>\n                                <div class=\"col-md-6\">\n                                    <input type=\"text\" id=\"name\" class=\"form-control border-input\" v-model=\"name\" placeholder=\"Gavin Belson\" required=\"\">\n                                </div>\n                            </div>\n                            <div class=\"form-group\" v-bind:class=\"{ 'has-error': error &amp;&amp; response.email }\">\n                                <label for=\"email\" class=\"col-md-3 control-label\">E-mail</label>\n                                <div class=\"col-md-6\">\n                                    <input type=\"email\" id=\"email\" class=\"form-control border-input\" placeholder=\"gavin.belson@hooli.com\" v-model=\"email\" required=\"\">\n                                </div>\n                            </div>\n                            <div class=\"form-group\">\n                                <center>\n                                <span class=\"help-block\" style=\"color: red;\" v-if=\"error &amp;&amp; response.email\">{{ response.email}}</span>\n                                </center>\n                            </div>\n                            <div class=\"form-group\" v-bind:class=\"{ 'has-error': error &amp;&amp; response.password }\">\n                                <label for=\"password\" class=\"col-md-3 control-label\">Password</label>\n                                <div class=\"col-md-6\">\n                                    <input type=\"password\" id=\"password\" class=\"form-control border-input\" placeholder=\"********\" v-model=\"password\" required=\"\">\n                                </div>\n                            </div>\n                            <div class=\"form-group\">\n                                <center>\n                                <span class=\"help-block\" style=\"color: red;\" v-if=\"error &amp;&amp; response.password\">{{ response.password}}</span>\n                                </center>\n                            </div>\n\n                            <div class=\"form-group\">\n                                <label for=\"password_confirmation\" class=\"col-md-3 control-label\">Confirm Password</label>\n                                <div class=\"col-md-6\">\n                                    <input type=\"password\" id=\"password_confirmation\" class=\"form-control border-input\" placeholder=\"********\" v-model=\"password_confirmation\" required=\"\">\n                                </div>\n                            </div>\n\n                            <div class=\"form-group\">\n                                <center>\n                                <button type=\"submit\" class=\"btn btn-l btn-primary\">\n                                    Register\n                                </button>\n                                </center>\n                            </div>\n                        </form>\n                    </div>\n                </div>\n            </div>\n        </div>\n    </div>\n    <footer class=\"footer navbar-default\" style=\"bottom: 0;width:100%;position: absolute;\">\n\n        <div class=\"container-fluid\">\n\n            <div class=\"copyright pull-right\">\n                © 2017 Transporter. All Rights Reserved\n            </div>\n\n        </div>\n\n    </footer>\n</div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-41f67113", module.exports)
  } else {
    hotAPI.update("_v-41f67113", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"../js/auth.js":20,"vue":8,"vue-hot-reload-api":3}],18:[function(require,module,exports){
'use strict';
...
exports.default = {
    ...
    methods: {
        login: function login(event) {
            event.preventDefault();
            _auth2.default.login(this, this.email, this.password);
        }
    },
    mounted: function mounted() {
        _auth2.default.check(true);
    }
};
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<div class=\"wrapper\">\n\n    <nav class=\"navbar navbar-default\">\n\n        <div class=\"container-fluid\">\n\n            <div class=\"navbar-header\">\n                <router-link :to=\"{ name: 'login'}\" class=\"navbar-brand\">Transporter</router-link>\n            </div>\n        </div>\n    </nav>\n<div class=\"container\">\n    <div class=\"row\">\n        <div class=\"col-md-8 col-md-offset-2\">\n            <div class=\"panel panel-default\">\n\n                <div class=\"panel-heading\">Login</div>\n                <div class=\"panel-body\">\n                    <div class=\"alert alert-danger\" v-if=\"error\">\n                        <p>Invalid Credentials</p>\n                    </div>\n                    <form class=\"form-horizontal\" role=\"form\" v-on:submit=\"login\">\n                        <div class=\"form-group\">\n                            <label for=\"email\" class=\"col-md-4 control-label\">E-Mail Address</label>\n                            <div class=\"col-md-6\">\n                                <input v-model=\"email\" id=\"email\" type=\"email\" placeholder=\"Email\" class=\"form-control border-input\" name=\"email\" required=\"\" autofocus=\"\">\n                            </div>\n                        </div>\n                        <div class=\"form-group\">\n                            <label for=\"password\" class=\"col-md-4 control-label\">Password</label>\n                            <div class=\"col-md-6\">\n                                <input v-model=\"password\" id=\"password\" type=\"password\" placeholder=\"Password\" class=\"form-control border-input\" name=\"password\" required=\"\">\n                            </div>\n                        </div>\n                        <!--<center>-->\n                            <!--<div class=\"form-group\">-->\n                                <!--<label>-->\n                                    <!--<input type=\"checkbox\" name=\"remember\"> Remember Me-->\n                                <!--</label>-->\n                            <!--</div>-->\n                        <!--</center>-->\n                        <div class=\"form-group\">\n                            <div>\n                                <center>\n                                    <button type=\"submit\" class=\"btn btn-l btn-primary \">\n                                        Login\n                                    </button>\n                                    <router-link :to=\"{ name: 'forgetPassword'}\" class=\"btn btn-link\">Forgot Your Password?</router-link>\n                                    <!--<a class=\"btn btn-link\">-->\n                                        <!--Forgot Your Password?-->\n                                    <!--</a>-->\n                                </center>\n                            </div>\n                        </div>\n                    </form>\n                </div>\n            </div>\n        </div>\n    </div>\n</div>\n    <footer class=\"footer navbar-default\" style=\"bottom: 0;width:100%;position: absolute;\">\n\n        <div class=\"container-fluid\">\n\n            <div class=\"copyright pull-right\">\n                © 2017 Transporter. All Rights Reserved\n            </div>\n\n        </div>\n\n    </footer>\n</div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-7a7f9092", module.exports)
  } else {
    hotAPI.update("_v-7a7f9092", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"../js/auth.js":20,"vue":8,"vue-hot-reload-api":3}],19:[function(require,module,exports){
'use strict';
...
var _AuthLayout = require('../components/AuthLayout.vue');
...
var _ManageOrder = require('../components/ManageOrder.vue');

var _ManageOrder2 = _interopRequireDefault(_ManageOrder);

var _ForgetPassword = require('../components/ForgetPassword.vue');
...
var _Orders = require('../components/Orders.vue');

var _Orders2 = _interopRequireDefault(_Orders);

var _PlaceOrder = require('../components/PlaceOrder.vue');

var _PlaceOrder2 = _interopRequireDefault(_PlaceOrder);

var _DeliveryMen = require('../components/DeliveryMen.vue');

var _DeliveryMen2 = _interopRequireDefault(_DeliveryMen);

var _Money = require('../components/Money.vue');
...
var VueResourceProgressBarInterceptor = require('vue-resource-progressbar-interceptor');
Vue.use(VueRouter);
Vue.use(VueResource);
...
exports.default = Vue;
var router = exports.router = new VueRouter({
    routes: [{
        path: '/',
        name: 'login',
        ...
        meta: {
            progress: {
                func: [{ call: 'color', modifier: 'temp', argument: '#008000' }, { call: 'fail', modifier: 'temp', argument: '#6e0000' }, { call: 'location', modifier: 'temp', argument: 'top' }, {
                    call: 'transition',
                    modifier: 'temp',
        ...
        children: [{
            ...
            path: 'placeOrder',
            name: 'placeOrder',
            component: _PlaceOrder2.default,
            meta: {
                progress: {
                    func: [{ call: 'color', modifier: 'temp', argument: '#008000' }, { call: 'fail', modifier: 'temp', argument: '#6e0000' }, { call: 'location', modifier: 'temp', argument: 'top' }, {
                        call: 'transition',
            ...
            component: _ManageOrder2.default,
            meta: {
                progress: {
                    func: [{ call: 'color', modifier: 'temp', argument: '#008000' }, { call: 'fail', modifier: 'temp', argument: '#6e0000' }, { call: 'location', modifier: 'temp', argument: 'top' }, {
                        call: 'transition',
            ...
            path: 'deliveryMen',
            name: 'deliveryMen',
            component: _DeliveryMen2.default,
            meta: {
                progress: {
                    func: [{ call: 'color', modifier: 'temp', argument: '#008000' }, { call: 'fail', modifier: 'temp', argument: '#6e0000' }, { call: 'location', modifier: 'temp', argument: 'top' }, {
                        call: 'transition',
...
new Vue({
    ...
    router: router,
    render: function render(h) {
        return h(_AuthLayout2.default);
    }
});

},{"../components/AuthLayout.vue":9,"../components/DeliveryMen.vue":10,"../components/ForgetPassword.vue":11,"../components/Home.vue":12,"../components/ManageOrder.vue":13,"../components/Money.vue":14,"../components/Orders.vue":15,"../components/PlaceOrder.vue":16,"../components/Register.vue":17,"../components/Signin.vue":18,"vue":8,"vue-progressbar":4,"vue-resource":6,"vue-resource-progressbar-interceptor":5,"vue-router":7}],20:[function(require,module,exports){
'use strict';
...
exports.default = {
    ...
    check: function check(flag) {
        ...
        if (localStorage.getItem('id_token') !== null) {
            _app2.default.http.get('api/user').then(function (response) {
                _this.user.authenticated = true;
                _this.user.profile = response.data.data;
            });
            if (flag) _app.router.push({ name: 'orders' });
        } else {
            if (!flag) {
    ...
    register: function register(context, email, password, password_confirmation, name) {
        context.success = false;
        context.error = false;
        _app2.default.http.post('api/register', {
            email: email,
            password: password,
            name: name,
    ...
    login: function login(context, email, password) {
        ...
        _app2.default.http.post('api/login', {
            email: email,
            password: password
        }).then(function (response) {
            context.error = false;
            localStorage.setItem('id_token', response.data.meta.token);
            _app2.default.http.headers.common['Authorization'] = 'Bearer ' + localStorage.getItem('id_token');
            _this2.user.authenticated = true;
            _this2.user.profile = response.data.data;
            _app.router.push({ name: 'orders' });
        }, function (response) {
            context.error = true;
        });
    },
...
},{"./app.js":19}],21:[function(require,module,exports){
'use strict';
...
exports.default = {
    getDeliveryMen: function getDeliveryMen(context) {
        context.error = false;
        _app2.default.http.get('api/getDeliveryMen').then(function (response) {
...
},{"./app.js":19}],22:[function(require,module,exports){
'use strict';
...
},{"./app.js":19}],23:[function(require,module,exports){
'use strict';
...
exports.default = {
    getSpecificOrder: function getSpecificOrder(context) {
        context.error = false;
        _app2.default.http.get('api/getSpecificOrder/' + context.orderID).then(function (response) {
    ...
    getOrders: function getOrders(context) {
        context.error = false;
        _app2.default.http.get('api/getOrders').then(function (response) {
    ...
    placeOrder: function placeOrder(order) {
        order.success = false;
        order.error = false;
        _app2.default.http.post('api/placeOrder', {
    ...
    cancelOrder: function cancelOrder(context) {
        _app2.default.http.post('api/cancelOrder/' + context.orderID).then(function (response) {
            _app.router.push({ name: 'orders' });
        }, function (response) {
            context.error = true;
        });
    },
    updateOrder: function updateOrder(context) {
        context.error = false;
        context.success = false;
        _app2.default.http.post('api/updateOrder/' + context.orderID, {
    ...
    export: function _export(context) {
        context.error = false;
        _app2.default.http.get('api/exportOrders').then(function (response) {
            context.error = false;
        }, function (response) {
            context.error = true;
        });
